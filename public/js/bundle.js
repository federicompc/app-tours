...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZmVkZXJpY29tcGMiLCJhIjoiY2t1NGdoc3o0NHFoeDJvcDNzbXNmOGZiMyJ9.Js-qZOl3uDa7LWimioejbA';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log(currentLocation.host); // var stripe = await Stripe(
          ...
          case 5:
            ...
            window.location.replace(session.data.session.url); // 2) Create checkout form + chanre credit card
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); // console.log('hola!', userDataForm);
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              document.querySelector('.btn__save-password').textContent = 'UPDATING...'; // console.log('estoy en update pass');
